...
#define SF32LB_PMUC_CLK_INIT(inst)                                                                 \
	BUILD_ASSERT(!SF32LB_PMUC_HAS_LXT32(inst) || DT_INST_NODE_HAS_PROP(inst, pinctrl_0),      \
		     "LXT32 requires pinctrl-0 on PMUC clock controller");                        \
	COND_CODE_1(DT_INST_NODE_HAS_PROP(inst, pinctrl_0), (PINCTRL_DT_INST_DEFINE(inst);), ()); \
