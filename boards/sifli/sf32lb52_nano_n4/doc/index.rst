.. zephyr:board:: sf32lb52_nano_n4

Overview

SF32LB52-DevKit-Nano-N4 is a compact development board based on the SF32LB52x
series SoC. It is mainly used for developing and evaluating applications
based on the SF32LB52x series chip.

More information about the board can be found at the
SF32LB52-DevKit-Nano website_.

Hardware

SF32LB52-DevKit-Nano-N4 provides the following hardware components:
...
SF32LB52BU56 SoC
  ...
  48MHz crystal
  32.768KHz crystal
  4MB internal NOR Flash @ 96MHz
  Bluetooth Low Energy and 2.4GHz wireless connectivity

Memory

  On-chip SRAM
  4MB internal NOR Flash (no external flash)
